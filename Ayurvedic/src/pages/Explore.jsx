const Explore = () => {
  return (
    <div className="Explore">
      <div className="h-full relative w-full flex flex-col items-center p-5">
        ...
        <div className="flex gap-10">
            <img src="https://corehealthandwellness.in/wp-content/uploads/2024/07/WhatsApp_Image_2024-07-22_at_4.36.36_PM__2_-removebg-preview.png" alt="" className=" h-60 w-60" />
            <img src="https://corehealthandwellness.in/wp-content/uploads/2024/07/WhatsApp_Image_2024-07-22_at_4.36.36_PM__1_-removebg-preview.png" alt="" className=" h-60 w-60" />
        </div>
      </div>
    </div>
  );
